...
use crate::server::spokes_handler;
...
const PROVIDER: &str = crate::PACKAGE;
...
fn openapi_spec() -> utoipa::openapi::OpenApi {
    ...
    spec.info.version = crate::SIGNALK_RADAR_API_VERSION.to_string();
    spec
}
...
struct AcquireTargetRequest {
    /// Target bearing in radians true [0, 2Ï€)
...
// Helper that turns a `DateTime` into an RFCâ€‘3339 string when serializing
